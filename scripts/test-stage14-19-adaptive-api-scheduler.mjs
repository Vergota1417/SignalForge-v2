...
import { executionProbeEligible, selectPriorityExecutionCandidates } from '../src/screener.js';
...
assert.equal(pulsed.intradayConfirmation,confirmation,'five-minute pulse must preserve completed 15m confirmation object');
