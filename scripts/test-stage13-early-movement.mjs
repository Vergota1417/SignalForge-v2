...
const building=earlyMovementSignal({scoreVelocity:10,relativeVolume:1.8,changePct:2.4,rollingDiscoveryScore:65});
...
const evidence=radarEvidenceRow({symbol:'NVDA',price:125,changePct:2.4,rollingDiscoveryScore:65,scoreVelocity:10,relativeVolume:1.8,dollarVolume:25_000_000,earlyMovement:building},{now:1_800_000});
