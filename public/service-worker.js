const CACHE_NAME='signalforge-shell-v7';
const APP_SHELL=['/','/index.html','/styles.css','/pwa.css','/radar.css','/push.css','/config.js','/app.js','/pwa.js','/radar-ui.js','/push-ui.js','/alert-history.js','/chart-inspector.js','/manifest.webmanifest','/icons/signalforge-icon.svg','/icons/signalforge-maskable.svg'];
