(() => {
  ...
  function loadFinancialCharting(){
    const boot=()=>loadScriptThen('/pattern-chart-hook.js','sf-pattern-chart-hook',()=>loadScriptThen('/chart-adapter.js','sf-financial-chart',()=>loadScriptThen('/chart-control-reliability.js','sf-chart-controls',()=>loadScriptThen('/pattern-context-ui.js','sf-pattern-context',()=>loadScriptThen('/pattern-overlay-reliability.js','sf-pattern-overlay-reliability')))));
